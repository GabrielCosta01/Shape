...
export const DeleteShape = () => {
    ...
    const customStyles = {
        overlay: {
            backgroundColor: "rgba(0, 0, 0, 0.287)",
        },
        content: {
        top: "50%",
        left: "50%",
            ...
            transition={{ delay: 0.2 }}>
                <div className="bg-bg-form px-5 py-3 gap-6 flex flex-col items-center">
                    <div className="w-full flex justify-between items-center">
                        <h2 className="text-purple-1 text-2xl font-semibold">Deletar Shape</h2>
                        <IoClose
                    ...
                    <div className="flex gap-4">
                        <button 
                            ...
                            className="text-white px-1.5 py-1.5 bg-btn-del w-36 rounded shadow-[0_2px_30px_-10px_rgba(0,0,0,0.3)]  hover:shadow-btn-del/100 duration-300">Deletar
                        </button>
                        <button 
                            onClick={() => isCloseModalDelete()}
                            className="text-white px-1.5 py-1.5 bg-grey-1 w-36 rounded shadow-[0_2px_30px_-10px_rgba(0,0,0,0.3)]  hover:shadow-button-register/100 duration-300">Cancelar
                        </button>
                    </div>
                </div>
            </motion.div>
